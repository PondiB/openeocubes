...
datacube_crop <- p$load_collection(
  ...
  temporal_extent = c("2017-08-01T00:00:00Z", "2017-09-30T23:59:59Z"),
...
model_svm_poly <- p$mlm_class_svm(
  kernel = "poly",
  C = 1,
  gamma = 0.1,   
  degree = 2,    
...
model_svm <- p$mlm_class_svm(kernel = "poly", C = 1, gamma = 0.1, degree = 2, coef0 = 1, seed = 42)
